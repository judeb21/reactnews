        ...
        <div className="flex flex-col md:gap-10 gap-[70px] items-center justify-start w-full">
          ...
          <div className="flex flex-col md:gap-10 gap-[120px] items-center justify-start w-full">
            <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between max-w-[1291px] mx-auto md:px-5 w-full">
              ...
              <div className="bg-white_A700 border border-bluegray_900 border-solid flex md:flex-1 items-center justify-start p-[49px] md:px-10 sm:px-5 w-[41%] md:w-full">
                <div className="flex flex-col md:gap-10 gap-[60px] items-center justify-start mb-[3px] rounded-[10px] w-[93%] md:w-full">
                  ...
                  <div className="flex flex-col items-start justify-start pt-[3px] rounded-[10px] w-full">
                    ...
                    <Button
                      className="common-pointer cursor-pointer font-medium font-poppins min-w-[400px] sm:min-w-full mt-[30px] text-base text-center text-white_A700 tracking-[0.08px] w-auto"
                    ...
                    <Text
                      className="font-inter font-normal md:ml-[0] ml-[50px] mt-[30px] not-italic text-black_900 text-left tracking-[-0.50px] w-auto"
                      variant="body4"
                    ></Text>
                  </div>
                </div>
